...
public class JaegerTest {
    public static void main(String[] args) {
        ...
        System.out.println("\nОбъект jaeger1 после создания при помощи конструктора без аргументов:");
        ...
        System.out.println("\nОбъект jaeger1 после присвоения его полям значений с помощью сеттеров:");
        System.out.println(jaeger1);

        jaeger1.setStatus("Destroyed");
        jaeger1.setWeight(52544);

        System.out.println("\nОбъект jaeger1 после изменения значений Status и Weight:");
        System.out.println(jaeger1);

        Jaeger jaeger2 = new Jaeger("Striker Eureka", "Mark-5", "Active", 76.20, 2087);

        System.out.println("\nОбъект jaeger2 после инициализации " +
                "при помощи параметризованного конструктора:");
        System.out.println(jaeger2);

        jaeger2.setHeight(-100);
        jaeger2.setWeight(0);

        System.out.println("\nHeight и Weight jaeger2 после попытки присвоения неположительных значений:");
