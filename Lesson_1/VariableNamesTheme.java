public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        // Стоимость кофе
        float coffePrice = 10.99f;
        System.out.println("Стоимость кофе: $" + coffePrice);

        // Начальная дата
        String startDate = "25.05.2026";
        ...
        String employeeOfMonthName = "Иван Иванов";
        ...
        // Компьютер включён?
        boolean isOn = false;
        System.out.println("Компьютер включён? " + isOn);
        ...
        int newCid = 25_347;
        System.out.println("Новый ID клиента: " + newCid);
